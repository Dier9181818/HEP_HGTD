...
void combine1()
{
 ...
 for (int i =0; i<5; ++i)
 {
  ...
  c_b101_105->SaveAs("b101_105.pdf");
...
// batche 601-605
 ...
 TCanvas *c_b601_605 = new TCanvas("c_b601_605", "c_b601_605");
  ...
  c_b601_605->SaveAs("b601_605.pdf");
...
TCanvas *c_b1101_1105 = new TCanvas("c_b1101_1105", "c_b1101_1105");
  ...
  c_b1101_1105->SaveAs("b1101_1105.pdf");
...
TCanvas *c_b1201_1205 = new TCanvas("c_b1201_1205", "c_b1201_1205");
  ...
  c_b1201_1205->SaveAs("b1201_1205.pdf");
...
////-----------%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-----------------------------------------------------
  ...
  mg->GetYaxis()->SetRangeUser(20,140);
  mg->GetXaxis()->SetLimits(50, 800);
  mg->Draw("APL");
  ...
  legend->Draw();
  //TLatex* ltx1 = new TLatex();
  ltx1->DrawLatex(70, 140,"#bf{HGTD TestBeam}");
  //c1->SaveAs("Time_Reso_Final.png");//
  c1->SaveAs("Time_Reso_Final.pdf");
